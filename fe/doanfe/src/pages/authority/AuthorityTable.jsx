...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, Grid2, IconButton, MenuItem } from '@mui/material';
...
export default function AuthorityTable({ userData }) {
