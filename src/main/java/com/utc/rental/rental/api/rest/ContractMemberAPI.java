...
public class ContractMemberAPI {
	...
	@PostMapping("")
	public ResponseDTO<ContractMemberDTO> create(@RequestBody @Valid ContractMemberDTO ContractMemberDTO)
	...
	@PutMapping("")
	public ResponseDTO<ContractMemberDTO> update(@RequestBody ContractMemberDTO ContractMemberDTO)
			throws URISyntaxException {
	...
	public ResponseDTO<ContractMemberDTO> get(@PathVariable(value = "id") String id) {
		...
		ContractResponseDTO contractResponseDTO = new ModelMapper().map(contractMember.getContract(),
