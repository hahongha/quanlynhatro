...
//    }
	...
	@PostMapping("/upload")
    public ResponseEntity<?> uploadImages(@RequestPart("file") MultipartFile[] files) {
       
        // Trả về danh sách URL của các ảnh đã upload
        return ResponseEntity.ok(cloudinaryService.uploadMultipartFile(files, "TEST"));
    }
